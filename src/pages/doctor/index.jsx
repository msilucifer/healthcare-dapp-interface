  ...
  const addRecordCallback = useCallback(
    async (file, fileName, patientAddress) => {
      ...
      try {
        ...
        const ipfsHash = (await axios.post("https://api.pinata.cloud/pinning/pinFileToIPFS", formData, {
        ...
        if (ipfsHash) {
          await contract.methods.addRecord(ipfsHash.IpfsHash, fileName, patientAddress).send({ from: accounts[0] })
